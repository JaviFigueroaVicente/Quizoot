<template>
    <div class="grid">
        <div class="col-12">
            <div class="card">
                <!-- Tabla con los datos de los formularios respondidos por el usuario recuperado -->
...
// Recuperado de los datos de los formularios respondidos filtrados por usuario
onMounted(() => {
